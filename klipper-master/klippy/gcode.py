...
class GCodeCommand:
    ...
    def __init__(self, gcode, command, commandline, params, need_ack):
        logging.info("[log](+)gcode.py/GCodeCommand/__init__")
	...
	logging.info("[log](+/-)gcode.py/GCodeCommand/get_command")
        return self._command
    def get_commandline(self):
	logging.info("[log](+/-)gcode.py/GCodeCommand/get_commandline")
        return self._commandline
    def get_command_parameters(self):
	logging.info("[log](+/-)gcode.py/GCodeCommand/get_command_parameters")
        return self._params
    def get_raw_command_parameters(self):
	logging.info("[log](+)gcode.py/GCodeCommand/get_raw_command_parameters")
	...
	logging.info("[log](+)gcode.py/GCodeCommand/ack")
	...
	logging.info("[log](+)gcode.py/GCodeCommand/get")
	...
	logging.info("[log](+/-)gcode.py/GCodeCommand/get_int")
    ...
    def get_float(self, name, default=sentinel, minval=None, maxval=None,
                  above=None, below=None):
	logging.info("[log](+/-)gcode.py/GCodeCommand/get_float")
...
class GCodeDispatch:
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/__init__")
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/is_traditional_gcode")
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/register_command")
        if func is None:
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/register_mux_command")
	...
	logging.info("[log](+/-)gcode.py/GCodeDispatch/get_command_help")
        return dict(self.gcode_help)
    def register_output_handler(self, cb):
	logging.info("[log](+/-)gcode.py/GCodeDispatch/register_output_handler")
        self.output_callbacks.append(cb)
    def _handle_shutdown(self):
	logging.info("[log](+)gcode.py/GCodeDispatch/_handle_shutdown")
	...
	logging.info("[log](+/-)gcode.py/GCodeDispatch/_handle_disconnect")
        self._respond_state("Disconnect")
    def _handle_ready(self):
	logging.info("[log](+)gcode.py/GCodeDispatch/_handle_ready")
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/_process_commands")
	...
	logging.info("[log](+/-)gcode.py/GCodeDispatch/run_script_from_command")
        self._process_commands(script.split('\n'), need_ack=False)
    def run_script(self, script):
	logging.info("[log](+)gcode.py/GCodeDispatch/run_script")
        with self.mutex:
            self._process_commands(script.split('\n'), need_ack=False)
	logging.info("[log](-)gcode.py/GCodeDispatch/run_script")
    def get_mutex(self):
	logging.info("[log](+/-)gcode.py/GCodeDispatch/get_mutex")
        return self.mutex
    def create_gcode_command(self, command, commandline, params):
	logging.info("[log](+/-)gcode.py/GCodeDispatch/create_gcode_command")
        return GCodeCommand(self, command, commandline, params, False)
    # Response handling
    def respond_raw(self, msg):
	logging.info("[log](+)gcode.py/GCodeDispatch/respond_raw")
        for cb in self.output_callbacks:
            cb(msg)
	logging.info("[log](-)gcode.py/GCodeDispatch/respond_raw")
    def respond_info(self, msg, log=True):
	logging.info("[log](+)gcode.py/GCodeDispatch/respond_info")
        if log:
            logging.info(msg)
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/_respond_error")
        logging.warning(msg)
	...
	logging.info("[log](+/-)gcode.py/GCodeDispatch/_respond_state")
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/_get_extended_params")
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/cmd_default")
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/_cmd_mux")
	...
	logging.info("[log](+/-)gcode.py/GCodeDispatch/cmd_M110")
        # Set Current Line Number
        pass
    def cmd_M112(self, gcmd):
	logging.info("[log](+/-)gcode.py/GCodeDispatch/cmd_M112")
        # Emergency Stop
        self.printer.invoke_shutdown("Shutdown due to M112 command")
    def cmd_M115(self, gcmd):
	logging.info("[log](+)gcode.py/GCodeDispatch/cmd_M115")
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/request_restart")
	...
	logging.info("[log](+/-)gcode.py/GCodeDispatch/cmd_RESTART")
        self.request_restart('restart')
    cmd_FIRMWARE_RESTART_help = "Restart firmware, host, and reload config"
    def cmd_FIRMWARE_RESTART(self, gcmd):
	logging.info("[log](+/-)gcode.py/GCodeDispatch/cmd_FIRMWARE_RESTART")
        self.request_restart('firmware_restart')
    def cmd_ECHO(self, gcmd):
	logging.info("[log](+/-)gcode.py/GCodeDispatch/cmd_ECHO")
        gcmd.respond_info(gcmd.get_commandline(), log=False)
    cmd_STATUS_help = "Report the printer status"
    def cmd_STATUS(self, gcmd):
	logging.info("[log](+)gcode.py/GCodeDispatch/cmd_STATUS")
        if self.is_printer_ready:
            self._respond_state("Ready")
            return
	...
	logging.info("[log](+)gcode.py/GCodeDispatch/cmd_HELP")
        cmdhelp = []
        if not self.is_printer_ready:
...
class GCodeIO:
    def __init__(self, printer):
	logging.info("[log](+)gcode.py/GCodeIO/__init__")
        self.printer = printer
        printer.register_event_handler("klippy:ready", self._handle_ready)
        printer.register_event_handler("klippy:shutdown", self._handle_shutdown)
	...
	logging.info("[log](-)gcode.py/GCodeIO/__init__")
    def _handle_ready(self):
	logging.info("[log](+)gcode.py/GCodeIO/_handle_ready")
        self.is_printer_ready = True
	...
	logging.info("[log](+)gcode.py/GCodeIO/_dump_debug")
        out = []
	...
	logging.info("[log](-)gcode.py/GCodeIO/_dump_debug")
    def _handle_shutdown(self):
	logging.info("[log](+)gcode.py/GCodeIO/_handle_shutdown")
        if not self.is_printer_ready:
            return
        self.is_printer_ready = False
        self._dump_debug()
	...
	logging.info("[log](+)gcode.py/GCodeIO/_process_data")
	...
	logging.info("[log](+)gcode.py/GCodeIO/_respond_raw")
	...
	logging.info("[log](+/-)gcode.py/GCodeIO/stats")
        return False, "gcodein=%d" % (self.bytes_read,)

def add_early_printer_objects(printer):
    logging.info("[log](+)gcode.py/GCodeIO/add_early_printer_objects")
