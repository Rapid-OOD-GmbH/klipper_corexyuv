...
class ForceMove:
	...
	u = gcmd.get_float('U', curpos[3])
	v = gcmd.get_float('V', curpos[4])
        logging.info("SET_KINEMATIC_POSITION pos=%.3f,%.3f,%.3f,%.3f,%.3f", x, y, z, u, v)
        toolhead.set_position([x, y, z, u, v, curpos[5]], homing_axes=(0, 1, 2, 3, 4))
